...
@Setter
@Entity
@Table(name = "TB_RGSTR_CASE_INFO_HIST")
@ToString
public class TbRgstrCaseInfoHist extends BaseTimeEntity {
    @Id
    @Column(name = "CASE_NO_SEQ", nullable = false)
    private Long caseNoSeq;
